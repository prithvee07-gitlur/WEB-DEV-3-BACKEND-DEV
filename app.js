...
// 14-8-2026 code
// question : Use http module and make a post request including data
// including data : name,email, password 
// condition : console.log should print request object

// end point submit honA CHANGIYE AND METHOD POST HONA CHAIYE
const http=require('http');
const server = http.createServer((req,res)=>{
